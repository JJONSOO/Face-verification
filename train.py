...
from dataset import MXFaceDataset, SyntheticDataset, DataLoaderX, Inha_Face
...
def main(args):
    ...
    train_set = Inha_Face()
    train_loader = torch.utils.data.DataLoader(train_set, shuffle = True, batch_size = 128, num_workers = 4)
